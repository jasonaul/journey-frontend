 ...
 */
 function Home() {
    return (<>
        ...
        <div className="inspiration"><hr></hr><h1 id="inspiroText">Find Event Inspiration</h1></div>
            <div className="inspirationImg">
           <a href="https://www.eventbrite.com/"> <img className="eventbrite" id="inspiroImg"  src="https://cdn.evbstatic.com/s3-build/731483-rc2022-10-05_16.04-d21b382/django/images/logos/eb_orange_on_white_1200x630.png"></img></a>
